import { BROWN, CORMORANT, LATO, LIGHT_BROWN, LIGHTER_BROWN, ORANGE } from "@/lib/helper";
...
const AboutBanner = () => (
  <section id="about" className="py-20 px-5 lg:px-8" style={{ background: "#fafaf8" }}>
    <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
      {/* Image collage */}
      <div className="grid grid-cols-2 gap-3">
        <ImagePlaceholder src="/story-1.JPG" height="230px" label="Story Image 1" rounded="4px" />
        <ImagePlaceholder src="/story-2.JPG" height="230px" label="Story Image 2" rounded="4px" />
        <ImagePlaceholder src="/story-4.JPG" height="230px" label="Story Image 3" rounded="4px" />
        <ImagePlaceholder src="/story-3.JPG" height="230px" label="Story Image 4" rounded="4px" />
      </div>
      ...
      <div>
        ...
        <h2
          ...
          style={{ fontFamily: CORMORANT, color: BROWN, letterSpacing: "0.03em", lineHeight: 1.15 }}
        >
          Rooted in Nature,{" "}
          <span className="italic" style={{ color: ORANGE }}>Guided by Science</span>
        </h2>
        ...
        <div className="grid grid-cols-2 gap-5 mb-8">
          {STATS.map((s) => (
            <div key={s.label}>
              <p className="text-3xl font-light" style={{ fontFamily: CORMORANT, color: BROWN }}>{s.value}</p>
              <p className="text-xs uppercase tracking-wider mt-0.5" style={{ color: BROWN, fontFamily: LATO }}>{s.label}</p>
            </div>
          ))}
        </div>
