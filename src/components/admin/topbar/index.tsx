...
const AdminTopbar = ({setSidebarOpen}: Props) => {
  return (
    <header
      className="h-14 bg-white border-b border-gray-100 flex items-center px-5 gap-4 flex-shrink-0"
    ...
    >
      ...
      <div className="relative hidden sm:block w-56">
        ...
        <Input
          ...
          className="h-8 pl-8 text-sm rounded-sm border-gray-200 bg-gray-50 focus-visible:ring-green-700/20 focus-visible:border-green-700 text-xs"
